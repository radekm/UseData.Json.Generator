    ...
    let private processTypeDeclaration
        ...
        let generate ast =
            ...
            let rec formatType = function
                ...
                | Ast.JVar v -> v
                | Ast.JArray element -> formatType element + "[]"
...
let ``input - mutually recursive types, without generated source`` = """
// ::UseData.Json.Generator::
type Type =
    | Ident of string
    | Func of parameters:Field[] * result:Field[]
...
let ``expected output - mutually recursive types, without generated source`` = """
// ::UseData.Json.Generator::
type Type =
    | Ident of string
    | Func of parameters:Field[] * result:Field[]
    ...
    // ::BEGIN:Generated by UseData.Json.Generator::
    // Type name: Type, cases: Ident of string, Func of Field[] * Field[]
    // ::END:Generated by UseData.Json.Generator::
...
and Field =
    ...
    // ::BEGIN:Generated by UseData.Json.Generator::
    // Type name: Field, fields: Name : string, Type : Type
    // ::END:Generated by UseData.Json.Generator::
"""

[<Test>]
let ``test generator - mutually recursive types, without generated source`` () =
    let result = Utils.generate ``input - mutually recursive types, without generated source``
    Assert.That(result.Changed, Is.True)
    Assert.That(
        result.Output,
        Is.EqualTo ``expected output - mutually recursive types, without generated source``)
